...
function FacebookIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 1.09.079 1.372.157v3.323a8.4 8.4 0 0 0-.73-.025c-1.036 0-1.436.392-1.436 1.413v2.69h3.046l-.522 3.667h-2.524v8.109C19.395 23.025 24 18.07 24 12.014 24 5.405 18.609.012 12 .012S0 5.405 0 12.014c0 5.427 3.788 9.964 8.86 11.116z" />
    </svg>
  );
}
